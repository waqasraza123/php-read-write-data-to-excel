...
class DataSource
{
    ...
    const DATABASENAME = 'catch_duplicates';
    ...
    public function getPostalCode($postalCode){
        return strtolower(preg_replace('/\s+/', '', $postalCode));
    }

    public function getPlainString($string){
        return preg_replace('/[^A-Za-z0-9\-]/', '', strtolower(preg_replace('/\s+/', '', $string)));
    }
    ...
    public function getDOB($dob){
        ...
        $date = (explode(" ", $dob))[0]; //return format YY/MM/DD
        $date = explode("-", $date);
